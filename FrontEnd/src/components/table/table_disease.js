...
let disease = [['phản ứng thuốc', 'ngừng dùng chất kích thích',
        ...
        ['loét dạ dày tá tràng', 'tránh thức ăn cay béo',
            'tiêu thụ thực phẩm sinh học', 'ngừng uống sữa',
        ...
        ['hen phế quản', 'chuyển sang cảm ứng lỏng lẻo',
            'lấy hơi thở sâu', 'tránh xa kích hoạt', 'tìm kiếm sự giúp đỡ'],
        ['viêm gan do rượu', 'ngừng tiêu thụ rượu',
            'lắng nghe ý kiến bác sĩ', 'sử dụng thuốc đặc trị',
            'theo dõi tình trạng bản thân'],
        ['bệnh vàng da', 'uống nhiều nước', 'tiêu thụ cây kế sữa',
            'ăn trái cây và thức ăn nhiều chất xơ', 'sử dụng thuốc đặc trị'],
        ['viêm gan E', 'ngừng tiêu thụ rượu', 'nghỉ ngơi',
            'lắng nghe ý kiến bác sĩ', 'sử dụng thuốc đặc trị'],
        ['sốt xuất huyết', 'uống nước đu đủ', 'tránh thức ăn cay béo',
            'giữ muỗi đi', 'giữ nước'],
        ...
        ['viêm khớp', 'tập thể dục', 'sử dụng liệu pháp nóng và lạnh',
            'hãy thử châm cứu', 'mát xa'],
        ['viêm đường tiêu hóa', 'ngừng ăn thức ăn đặc trong khi',
            'hãy thử uống những ngụm nước nhỏ', 'nghỉ ngơi',
            'dễ dàng trở lại ăn uống'],
        ['bệnh lao', 'che miệng', 'lắng nghe ý kiến bác sĩ',
